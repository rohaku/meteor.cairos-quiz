...
Router.configure({
    ...
    seo:{
        title: function(){
            return ' | The Giblog | ' + 'John Gibby - Baton Rouge Web Developer and Designer'
        },
        og: {
            site_name:function(){
                return ' | The Giblog | ' + 'John Gibby - Baton Rouge Web Developer and Designer'
...
//最后一个领取激活码
Router.route('/noreward.html', function() {
    this.render('SectionPageNoreward' + _routerDeviceType);
}, {
    name: 'facebook.noreward'
});
