...
Router.route('/claimcode.html', function() {
    this.render('checkGetCodeStatus');
    //if(Session.get("isFBLoaded")){
    //    var aaa = Meteor.call("checkGetStatusToGoPage");
    //    console.log(aaa);
    //}
    this.render('SectionPageFirstclaim'+ _routerDeviceType, {to: "first"});
    this.render('SectionPageClaim'+ _routerDeviceType, {to: "normal"});
    this.render('SectionPageNorewards'+ _routerDeviceType, {to: "last"});
}, {
